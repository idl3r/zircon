...
#define X86_MSR_IA32_PERF_CTL           0x00000199 /* performance control */
#define X86_MSR_IA32_CLOCK_MODULATION   0x0000019a /* clock modulation control */
...
#define X86_MSR_IA32_PKG_HDC_CTL        0x00000db0
